...
async function login(req, res) {
    try {
        ...
        logger.error('PORTAL_AUTH_CTRL', '门户登录失败', { error: error?.message || error });
...
async function getProfile(req, res) {
    try {
        ...
        logger.error('PORTAL_AUTH_CTRL', '获取门户资料失败', { error: error?.message || error });
...
async function changeInitialPassword(req, res) {
    try {
        ...
        logger.error('PORTAL_AUTH_CTRL', '修改门户密码失败', { error: error?.message || error });
