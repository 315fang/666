...
router.get('/mini-program-config', configController.getMiniProgramConfig);
...
// 获取指定位置的 Banner 列表（position: home/category/activity）
router.get('/banners', configController.getBannersByPosition);
