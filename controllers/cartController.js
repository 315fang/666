    ...
    try {
            ...
            include: [
                {
                    model: Product,
                    as: 'product',
                    attributes: ['id', 'name', 'images', 'retail_price', 'member_price', 'stock', 'status']
                },
                {
                    model: SKU,
                    as: 'sku',
                    attributes: ['id', 'spec_name', 'spec_value', 'retail_price', 'member_price', 'stock', 'image']
                }
            ],
        ...
        cartItems.forEach(item => {
            ...
            if (item.selected) {
                ...
                const price = item.sku ? item.sku.retail_price : item.product.retail_price;
