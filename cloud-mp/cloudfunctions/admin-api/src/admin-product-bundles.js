...
function registerProductBundleRoutes(app, deps) {
    ...
    function normalizeBundlePayload(raw = {}, existingRow = null) {
        ...
        return {
            ...
            hero_title: title,
            hero_subtitle: pickString(raw.subtitle || raw.hero_subtitle || raw.heroSubtitle || existingRow?.subtitle || existingRow?.hero_subtitle || ''),
    ...
    async function decorateBundle(row = {}) {
        ...
        return {
            ...
            hero_title: pickString(row.title || row.hero_title),
            hero_subtitle: pickString(row.subtitle || row.hero_subtitle),
