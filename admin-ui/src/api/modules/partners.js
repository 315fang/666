...
export const getDealers = (params) => request({ url: '/dealers', method: 'get', params }).then(normalizeListResult)
...
export const getAdmins = (params) => request({ url: '/admins', method: 'get', params }).then(normalizeListResult)
...
export const getPickupStations = (params) => request({ url: '/pickup-stations', method: 'get', params }).then(normalizeListResult)
export const getPickupStationById = (id) => request({ url: `/pickup-stations/${id}`, method: 'get' }).then(normalizeItemResult)
...
export const getBranchAgentStations = (params) => request({ url: '/branch-agents/stations', method: 'get', params }).then(normalizeListResult)
...
export const getBranchAgentClaims = (params) => request({ url: '/branch-agents/claims', method: 'get', params }).then(normalizeListResult)
